    ...
    <div class="___class_+?4___">
            ...
            <div class="container px-4 d-flex justify-content-between">
                ...
                <div>
                    <a href="{{ route('consultor.logout') }}"> <span class="iconify" data-inline="false"
                            data-icon="ls:logout" style="color: #ffffff; font-size: 38.42677688598633px;"></span></a>
                </div>
            </div>
        </div>
        @php
        ...
        <div class="container mt-3">
            <div class="ativos px-4">
                <div class="py-4">
                    <a href="{{ route('consultor.compradores.ativo') }}"> <i class="fas fa-thumbs-up"></i> Compradores
                        Ativos</a>
            ...
            <div class="menu row">
                <div class="col-5 text-center altura pl">
                    <a href="{{ url('comprador-cad') }}"><span class="iconify" data-inline="false"
                            data-icon="bx:bx-user-plus" style="color: #36a6d4; font-size: 75.05713653564453px;"></span>
                        <p>CADASTRO DE COMPRADOR</p>
                    </a>
                </div>
                <div class="col-5 text-center altura pl">
                    <a href="{{ route('consultor.extracto') }}"><span class="iconify mb-2 pt-2" data-inline="false"
                            data-icon="vaadin:piggy-bank" style="color: #36a6d4; font-size: 56px;"></span>
                        <p>VER SEU
                            EXTRACTO</p>
                    </a>
                </div>
                <div class="text-center mt-3 altura pl" style="max-width: 89%; flex: 0 0 89%; position: relative;">
                    <a href="{{ route('comprador.status') }}"> <img class="mb-3"
                            src="{{ url('app-comercial/img/ind.svg') }}" alt="">
                ...
                <div class="col-5 text-center mt-3  altura pl">
                    <a href="{{ route('consultor.list.incompletos') }}"><i style="color: #35A40E; font-size: 56px;"
                            class="fas fa-ban"></i></i>
                        <p>VER INCOMPLETOS</p>
                    </a>
                </div>
                <div class="col-5 text-center mt-3 altura pl">
                    <a href="{{ route('consultor.lead') }}"><i style="color: #35A40E; font-size: 56px;"
                            class="fab fa-envira"></i></span>
                        <p>CADASTRAR LEAD</p>
                    </a>
                </div>
            </div>
