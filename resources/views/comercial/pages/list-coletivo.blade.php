            ...
            <ul class="mdc-list mdc-list--two-line">
                  <li class="mdc-list-item" tabindex="0">
                        ...
                        <span class="mdc-list-item__text">
                              ...
                              <span class="mdc-list-item__secondary-text">{{ $comprador1->nome }}
                                    {{ $comprador1->sobrenome }}</span>
                        </span>
                  </li>
                  ...
                  <li class="mdc-list-item">
                        <span class="mdc-list-item__ripple"></span>
                        <span class="mdc-list-item__text">
                              <span class="mdc-list-item__primary-text">Tipo</span>
                              <span class="mdc-list-item__secondary-text">{{ $comprador1->tipo }}</span>
                        </span>
                  </li>
