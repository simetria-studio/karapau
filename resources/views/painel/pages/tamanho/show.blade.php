...
@section('content')
    ...
    <div class="card m-5 col-md-10">
        <form action="{{ route('admin.tamanhos.update', $tamanho->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1">Tamanho</label>
                        <input type="text" class="form-control" value="{{ $tamanho->name }}"name="name">
                    </div>
