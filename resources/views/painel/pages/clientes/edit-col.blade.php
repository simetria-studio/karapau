                        ...
                        <div class="col-12 mt-5">
                              <div class="card">
                                    ...
                                    <div class="card-body pad">
                                          <form action="{{ route('admin.update.coletivo', $comprador->id) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                      ...
                                                      <div class="form-group col-12 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" value="{{ $comprador->telemovel }}" name="telemovel">
                                                      </div>
                                                      <div class="form-group col-12 col-md-6">
                                                      ...
                                                      <div class="form-group col-12 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" value="{{ $comprador->coletivos[0]->contato }}" name="contato">
                                                      </div>
                                                      <div class="form-group col-12 col-md-6">
                                                            <label for="exampleInputEmail1">Telefone do Contato</label>
                                                            <input type="text" class="form-control" value="{{ $comprador->coletivos[0]->telefone }}" name="telefone">
                                                      </div>
                                                      <div class="form-group col-12 col-md-6">
                                                            <label for="exampleInputEmail1">Telemóvel do Contato</label>
                                                            <input type="text" class="form-control" value="{{ $comprador->coletivos[0]->telemovel_empresa }}" name="telemovel_empresa">
                                                      </div>
