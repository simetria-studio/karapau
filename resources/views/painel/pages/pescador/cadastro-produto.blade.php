                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Pescador - Adcionar Produtos</h3>
                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                        <select class="form-control" name="especie_id" id="margem">
                                            ...
                                            @foreach ($especies as $especie)
                                                <option value="{{ $especie->id }}" data-margem="{{ $especie->margem }}">
                                                    {{ $especie->nome_portugues }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-4">
                                        <select class="form-control" name="embarcacao" id="exampleFormControlSelect1">
                                            ...
                                            <option value="{{ $pescador->nome_embarcacao }}">
                                                {{ $pescador->nome_embarcacao }}</option>
                                            <option value="{{ $pescador->nome_embarcacao2 }}">
                                                {{ $pescador->nome_embarcacao2 }}</option>
                                            <option value="{{ $pescador->nome_embarcacao3 }}">
                                                {{ $pescador->nome_embarcacao3 }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12 d-flex justify-content-center">
                                        <div class="col-12 col-md-4 row">
                                            <div class="form-group col-6 text-center">
                                                ...
                                                <input id="check_kg" class="form-control" value="Kg" name="unidade"
                                                    type="radio">
                                            </div>
                                            <div class="form-group col-6 text-center">
                                                <label for="name-field">Unidade</label>
                                                <input id="check_unidade" value="Unidade" class="form-control"
                                                    name="unidade" type="radio">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-flex justify-content-center">
                                        <div class="col-12 col-md-3">
                                            <div class="receber">
                                                <input id="percent" class="form-control" disabled placeholder="Vai Receber"
                                                    type="text" value="">
                                            </div>
                                        </div>
                                    </div>
